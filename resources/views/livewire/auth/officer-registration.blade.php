<div>
    ...
    <div class="font-[sans-serif] relative" id="chooseYouth">
        ...
        <div class="relative -mt-40 m-4">
            <form wire:submit.prevent="officerRegister"
                class="bg-white max-w-xl w-full mx-auto shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6 sm:p-8 rounded-2xl">
                @csrf
                <div class="mb-12">
                    <h3 class="text-gray-800 text-3xl text-center">Officer Registration</h3>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb"
                            ...
                            <!-- Body -->
                            <path d="M6 12h12a5 5 0 0 1 5 5v1H1v-1a5 5 0 0 1 5-5z"></path>

                            <!-- Connections (Leadership Influence) -->
                            <circle cx="4" cy="6" r="2"></circle>
                            <circle cx="20" cy="6" r="2"></circle>
                            <circle cx="12" cy="18" r="2"></circle>
                            <path d="M6 8l4-2m8 2l-4-2m-8 8l4 2m8-2l-4 2"></path>
                        </svg>
                    </div>
                    @error('position')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="mt-8">
                    ...
                    @error('officer_password_confirmation')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-8">
                    ...
                    <p class="text-gray-800 text-sm mt-4 text-center">Already have an account? <a
                            href="{{ route('login') }}" class="text-blue-500 font-semibold hover:underline ml-1">Login
                            here</a></p>
                </div>
            </form>
        </div>
