    ...
    <div class="font-[sans-serif] relative" id="chooseYouth">
        ...
        <div class="relative -mt-40 m-4">
            <form wire:submit.prevent="youthRegister"
                ...
                <div class="mt-8">
                    <label class="text-gray-800 text-xs block mb-2">Age</label>
                    <div class="relative flex items-center">
                        <input wire:model="age" type="number"
                            ...
                            <!-- Body -->
                            <path d="M6 15h8a5 5 0 0 1 5 5v1H1v-1a5 5 0 0 1 5-5z" data-original="#000000"></path>
                            
                            <!-- Clock -->
                            <circle cx="18" cy="7" r="4" stroke-width="2" fill="none"></circle>
                            <path d="M18 5v2.5l1.5 1.5" stroke-width="2" stroke-linecap="round"></path>
                        </svg>                        
                    </div>
                    @error('age')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
