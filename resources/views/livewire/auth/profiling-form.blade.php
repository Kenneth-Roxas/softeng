    ...
    <div>
        ...
        <div class="mt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div
                            ...
                            <p class="text-lg leading-relaxed">
                                Good day! We are conducting a study assessing the demographic information of Katipunan
                                ng Kabataan.
                        ...
                        <form class="space-y-6 flex flex-col">
                            <h1 class="text-3xl font-bold text-center text-gray-800 mb-2">Profile</h1>
                            <div class="relative">
                                ...
                                <label for="name"
                                    class="absolute left-4 top-4 text-gray-600 text-base bg-white px-1 transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-sm peer-focus:top-2 peer-focus:text-blue-500 peer-focus:text-sm">
                            ...
                            <div class="relative">
                                ...
                                <label for="location"
                                    class="absolute left-4 top-4 text-gray-600 text-base bg-white px-1 transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-sm peer-focus:top-2 peer-focus:text-blue-500 peer-focus:text-sm">
                                    Location (Region, Province, Municipality, Barangay, Purok)
                                </label>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex space-x-4">
                                    <label
                                        ...
                                        <input type="radio" name="sex" class="mr-2 hidden">
                            ...
                            <div class="relative">
                                ...
                                <label for="age"
                                    class="absolute left-4 top-4 text-gray-600 text-base px-1 transition-all 
                            ...
                            <div class="relative">
                                <input type="email" id="email" required
                                    class="peer w-full border border-gray-300 rounded-lg px-4 pt-5 pb-2 text-base outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300 shadow-md">
                                <label for="email"
                                    class="absolute left-4 top-4 text-gray-600 text-base bg-white px-1 transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-blue-500 peer-focus:text-sm">
                                    Email Address
                                </label>
                            </div>
                            ...
                            <div class="flex justify-end mt-6">
                                @if ($currentStep > 1)
                                    <button wire:click="previousStep"
                                        class="bg-gradient-to-r from-red-500 to-red-600 text-white px-8 py-3 rounded-lg text-lg font-semibold shadow-md hover:opacity-90 transition">Back</button>
                                @endif
                                @if ($currentStep < 4)
                                    <button wire:click="nextStep"
                                        class="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-8 py-3 rounded-lg text-lg font-semibold shadow-md hover:opacity-90 transition">Next
                                        →</button>
                                @endif
                            </div>
                        </form>
                ...
                <div class="max-w-5xl mx-auto bg-white p-8 rounded-lg mt-3 shadow-lg border border-gray-300">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <form class="space-y-6 flex flex-col">
                            ...
                            <div>
                                <label class="block text-gray-700 font-semibold mb-2">Have you already attended a KK Assembly?</label>
                                <div class="flex space-x-4">
                                    <label
                                        class="flex items-center bg-gray-100 px-4 py-2 rounded-xl shadow hover:bg-gray-400 cursor-pointer">
                                        <input type="radio" name="sk_electionr" value="Yes" class="mr-2 hidden"
                                            onchange="toggleFollowUp(this)">
                                        <span class="text-base">Yes</span>
                                    </label>
                                    <label
                                        class="flex items-center bg-gray-100 px-4 py-2 rounded-xl shadow hover:bg-gray-400 cursor-pointer">
                                        <input type="radio" name="sk_electionr" value="No" class="mr-2 hidden"
                                            onchange="toggleFollowUp(this)">
                                        <span class="text-base">No</span>
                                    </label>
                                </div>
            ...
            @elseif ($currentStep == 4)
                <div class="flex items-center justify-center min-h-screen -mt-40 shadow-2xl bg-gray-100 border border-gray-300">
