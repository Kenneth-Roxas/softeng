    ...
    <div class="font-[sans-serif] max-w-7xl mx-auto h-screen">
        @if (session()->has('login_failed'))
            <div x-data="{ show: true }" x-show="show" x-transition.duration.500ms
                class="fixed top-5 right-5 bg-red-600 text-white px-6 py-3 rounded-lg shadow-lg flex items-center space-x-3">
        ...
        <div class="grid md:grid-cols-2 items-center gap-8 h-full">
            <form action="{{ route('login.button') }}" method="POST" class="max-w-lg max-md:mx-auto w-full p-6">
                ...
                <div class="mb-12">
                    ...
                    <p class="text-gray-500 text-sm mt-6">Immerse yourself in a hassle-free login journey with our
                ...
                <div class="mt-8">
                    <button type="submit"
                        class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                        Log in
                    </button>
                </div>
            ...
            <div
                class="max-h-screen md:py-6 flex items-center relative max-md:before:hidden before:absolute before:bg-gradient-to-r before:from-gray-50 before:via-[#E4FE66] before:to-[#55F5A3] before:h-full before:w-3/4 before:right-0 before:z-0">
                <img src="https://politiko.com.ph/wp-content/uploads/2022/05/sk-pay.jpg"
