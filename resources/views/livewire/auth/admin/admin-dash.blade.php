<div>
    ...
    <body class = "body bg-white dark:bg-[#0F172A]">
        <div class = "fixed w-full z-30 flex bg-white dark:bg-[#0F172A] p-2 items-center justify-center h-16 px-10">
            ...
            <div class = "flex-none h-full text-center flex items-center justify-center">
                ...
                <div class = "flex space-x-3 items-center px-3">
                    ...
                    <div class = "hidden md:block text-sm md:text-md text-black dark:text-white">Chairperson - Kenneth
                    </div>
                </div>
        ...
        <div class = "content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
            <nav class = "flex px-5 py-3 text-gray-700  rounded-lg bg-gray-50 dark:bg-[#1E293B] "
        ...
        <script>
            ...
            function setDark(mode) {
                ...
                applyTheme(); // Apply the theme and update icons immediately
            }
